...
async function getsource(db) {
	return new Promise(function(resolve) {
		let query = 'select id from ' + database + '.sources where name = "system.adapter.ems-esp.' + adapter.instance + '";';
...
async function getid(field,db) {
	return new Promise(function(resolve) {
		let query = 'select id from ' + database + '.datapoints where name = "' + field + '";';
