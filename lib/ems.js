...
const init = async function (a, i) {
    ...
    if (devs != -1) {
        adapter.log.info(
            '*** You are using a non-productive version of ems-esp gateway firmware. Use is on your own risk',
        );
    }
    if (vs != -1) {
        adapter.log.info(
            "*** Version 3.7. might change structure and names of warm water / dhw objects. Please adjust your scripts / vis ui's if necessary",
        );
    }
